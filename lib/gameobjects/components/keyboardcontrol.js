...
KeyboardControl.prototype = {
	...
	newHealth: function(){
		var healthComponent = this.entity.getComponent("health");
		var healthbar = this.entity.healthbar;
		var healthbarTextureRed = this.entity.healthbarTextureRed;
		var healthbarTextureGreen = this.entity.healthbarTextureGreen;
		...
		if(potionComponent.hasPotion()){
			...
			var textLogMessage = this.entity.name + " used 1 potion and healed for " + potionComponent.lifeGain + " life";
